...
CORTOS_INFO("q_3.x = %f",q_3.x/alpha);
CORTOS_INFO("q_3.y = %f", q_3.y/alpha);
CORTOS_INFO("q_3.z = %f",q_3.z/alpha);
CORTOS_INFO("q_4 = %f",q_4/alpha);
//CORTOS_INFO("alpha = %lm \n ",alpha);
return ;
}
